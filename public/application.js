...
var url = ' https://rocky-caverns-21242.herokuapp.com';
var loggedIn = 0;
var userId = void 0,
    token = void 0,
    plowId = void 0;
...
$('#adminButton').on('click', function () {
  var valEmail = $('#emailReg').val();
  var valPw = $('#passwordReg').val();
  var jsonData = '{ "credentials": { "email": "' + valEmail + '", "password": "' + valPw + '", "password_confirmation": "' + valPw + '" }}';
...
$('#signIn').on('click', function () {
  var valEmail = $('#emailLog').val();
  var valPw = $('#passwordLog').val();
  var jsonData = '{ "credentials": { "email": "' + valEmail + '", "password": "' + valPw + '" }}';
  console.log(jsonData);
  $.ajax({
    type: 'POST',
    contentType: 'application/json; charset=utf-8',
...
$('#addPlowBtn').on('click', function () {
  ...
  var timeInput = $('#timeAdd').val();
  var yearInput = $('#yearAdd').val();
  var modelInput = $('#modelAdd').val();
  var plowData = '{ "plows": { "last_run_time": "' + timeInput + '", "year_make": "' + yearInput + '", "model": ' + modelInput + '}}';
...
$('#changePwBtn').on('click', function () {
  var inputOld = $('#oldPw').val();
  var inputNew = $('#newPw').val();
  var pwData = '{"passwords": {"old": "' + inputOld + '", "new": "' + inputNew + '"}}';
...
$('#editPlowBtn').on('click', function () {
  var timeEdit = $('#timeRunEdit').val();
  var yearEdit = $('#yearEdit').val();
  var modelEdit = $('#modelEdit').val();
  var updatedPlow = '{ "plows": { "last_run_time": "' + timeEdit + '", "year_make": "' + yearEdit + '", "model": ' + modelEdit + '}}';
  $.ajax({
    url: url + '/plows/' + plowId,
    headers: { Authorization: 'Token token=' + token },
    contentType: 'application/json; charset=utf-8',
